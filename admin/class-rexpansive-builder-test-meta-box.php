 ...
 *
 */
class Rexpansive_Builder_Test_Meta_Box {
					...
					if( !empty( $result_rows[2] ) ) :		// If there isn't content that suits for the builder, go on
						...
						foreach( $result_rows[2] as $i => $section ) :
							if( $section == 'RexpansiveSection') :
								...
								?>
								<div class="builder-row clearfix z-depth-1" data-count="" data-gridcontent='' data-gridproperties='<?php echo $section_bg_setts; ?>' data-griddimension='<?php echo $section_dimension; ?>' data-layout='<?php echo $section_attr['layout']; ?>' data-sectionid='<?php echo $custom_section_name; ?>' data-backresponsive='<?php echo ( ( array_key_exists( 'responsive_background', $section_attr ) && '' != $section_attr['responsive_background'] ) ? json_encode($background_responsive) : '' ) ?>'>
									<div class="builder-row-contents">
										<div class="builder-edit-row-header">
											<button disabled class="btn-floating builder-delete-row waves-effect waves-light grey darken-2 tooltipped" data-position="bottom" data-tooltip="<?php _e('Delete row', 'rexspansive'); ?>">
										...
										<div class="builder-edit-row-wrap clearfix row valign-wrapper">
											...
											<div class="col s4 right-align builder-setting-buttons">
												<button class="background_section_preview btn-floating tooltipped" data-position="bottom" data-tooltip="<?php _e( 'Row background', 'rexspansive' ); ?>"<?php echo $section_bg_button_preview_style; ?>></button>
												...
												<button disabled class="btn-flat disabled builder-copy-row tooltipped" data-position="bottom" data-tooltip="<?php _e('Copy row', 'rexspansive'); ?>">
													<i class="material-icons grey-text text-darken-2">&#xE14D;</i>
												</button>
												<button disabled class="btn-flat disabled builder-move-row tooltipped" data-position="bottom" data-tooltip="<?php _e('Move row', 'rexspansive'); ?>">
													<i class="material-icons grey-text text-darken-2">&#xE8D5;</i>
												</button>
											</div>
										</div>
														...
														<?php
															if( !empty( $section_content ) ) :
																...
																foreach( $result_block[3] as $i => $attrs ) :
																	...
																	if( $block_attr['image_bg_block'] != '' && $block_attr['type_bg_block'] == 'full' ) {
																		...
																		$classEmpty = 'hidden';
																	} else if( $block_attr['color_bg_block'] != '' && $block_attr['type_bg_block'] != 'full' ) {
																		...
																		$background_block_setts['bg_img_type'] = $block_attr['type_bg_block'];
																		$classEmpty = 'hidden';
																	} else if( $block_attr['type_bg_block'] == 'natural' ) {
																		$background_block_setts['image'] = $block_attr['id_image_bg_block'];
																		$background_block_setts['url'] = $block_attr['image_bg_block'];
																		$background_block_setts['bg_img_type'] = $block_attr['type_bg_block'];
																	...
																	if( $background_block_setts['color'] != '' || $background_block_setts['image'] |= '' ) :
																	...
																	?>
																		<li id="<?php echo $block_attr['id']; ?>" class="<?php echo $block_attr['type']; echo $define_borders; ?> item z-depth-1 hoverable svg-ripple-effect" data-block_type="<?php echo $block_attr['type']; ?>" data-col="<?php echo $block_attr['col']; ?>" data-row="<?php echo $block_attr['row']; ?>" data-sizex="<?php echo $block_attr['size_x']; ?>" data-sizey="<?php echo $block_attr['size_y']; ?>" data-bg_settings='<?php echo $background_block_setts; ?>' data-block-custom-classes="<?php echo $block_custom_classes; ?>" data-content-padding="<?php echo $content_padding_settings; ?>">
																			<div class="element-actions">
																				<div class="builder-fab-row-widgets actions-center-icons fixed-action-btn horizontal">
																					...
																					<ul>
																						<li class="edit_handler btn-floating waves-effect waves-light tooltipped<?php if( $block_attr['type_bg_block'] == 'natural') : echo ' hide-edit-handler'; endif; ?>" data-position="bottom" data-tooltip="<?php _e('Text', 'rexpansive'); ?>"
																						<?php
																				...
																				<div class="actions-center-icons">
																					<div class="edit_handler btn-floating waves-effect waves-light tooltipped<?php if( $block_attr['type_bg_block'] == 'natural') : echo ' hide-edit-handler'; endif; ?>" data-position="bottom" data-tooltip="<?php _e('Text', 'rexpansive'); ?>"
																					<?php
																						if( $block_attr['type_bg_block'] == 'natural') :
																							echo ' style="display:none;"';
																						endif;
																			...
																			?>
																						...
																						?>
																							<div class="element-preview">
																								<img src="<?php echo wp_get_attachment_url( $block_attr['id_image_bg_block'] ); ?>" data-image_id="<?php echo $block_content; ?>">
																							</div>
																						<?php
																							else :
																						?>
																			...
																			?>
																						...
																						?>
																								<div class="element-preview">
																									<img src="<?php echo wp_get_attachment_url( $block_attr['id_image_bg_block'] ); ?>" data-image_id="<?php echo $result_block[5][$i]; ?>">
																								</div>
																						<?php
																							else :
																						?>
...
<div class="el-visual-size"><span><?php echo $block_attr['size_x'] . 'x' . $block_attr['size_y']; ?></span></div>
					...
					?>
<div class="builder-row builder-new-row clearfix z-depth-1" data-count="0" data-gridcontent="" data-gridproperties="<?php echo htmlspecialchars( $defaultsectionproperties ); ?>" data-griddimension="full" data-layout="fixed" data-sectionid="" data-backresponsive="<?php echo htmlspecialchars( $defaultsectionconfigs ); ?>">
	<div class="builder-row-contents">
		<div class="builder-edit-row-header">
			<button disabled class="btn-floating builder-delete-row waves-effect waves-light grey darken-2 tooltipped" data-position="bottom" data-tooltip="<?php _e('Delete row', 'rexspansive'); ?>">
				<i class="material-icons white-text">&#xE5CD;</i>
		...
		<div class="builder-edit-row-wrap clearfix row valign-wrapper">
			<div class="col s4">
				<div class="rex-edit-dimension-wrap">
					<input id="section-full-0" type="radio" 
						...
						class="builder-edit-row-dimension with-gap" value="full" checked title="Full" disabled />
					...
					<input id="section-boxed-0" type="radio" 
						name="section-dimension-0" 
						class="builder-edit-row-dimension with-gap" value="boxed" title="Boxed" disabled />
			...
			<div class="builder-buttons col s4 center-align">
				...
				<div class="builder-fab-row-widgets fixed-action-btn horizontal">
					...
					<ul>
						...
						<li>
							<button disabled class="btn-floating builder-add waves-effect waves-light tooltipped" value="empty" data-position="bottom" data-tooltip="<?php _e( 'Block space', $this->plugin_name ); ?>">
								<i class="material-icons rex-icon">H</i>
							</button>
						</li>
					</ul>
			...
			<div class="col s4 right-align builder-setting-buttons">
				<button class="background_section_preview btn-floating tooltipped" data-position="bottom" data-tooltip="<?php _e( 'Row background', $this->plugin_name ); ?>"></button>
				...
				<button disabled class="btn-flat disabled builder-copy-row tooltipped" data-position="bottom" data-tooltip="<?php _e('Copy row', $this->plugin_name); ?>">
					<i class="material-icons grey-text text-darken-2">&#xE14D;</i>
				</button>
				<button disabled class="btn-flat disabled builder-move-row tooltipped" data-position="bottom" data-tooltip="<?php _e('Move row', $this->plugin_name); ?>">
					<i class="material-icons grey-text text-darken-2">&#xE8D5;</i>
				</button>
			</div>
		</div>
			...
			<tr>
				<td colspan="" rowspan="" headers="">
					<div class="builder-add-row-wrap">
						<button disabled id="builder-add-row" class="builder-button btn-floating btn light-blue darken-1 waves-effect waves-light tooltipped" data-position="bottom" data-tooltip="<?php _e( 'Add row', $this->plugin_name ) ?>">
...
<div class="col s4 right-align builder-setting-buttons">
	...
	<div class="btn-flat builder-copy-row tooltipped" data-position="bottom" data-tooltip="<?php _e('Copy row', 'rexpansive'); ?>">
		<i class="material-icons grey-text text-darken-2">&#xE14D;</i>
	</div>
