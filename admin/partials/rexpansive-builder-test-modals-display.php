<?php
/**
 * Print the markup of the modals loader info
 *
        ...
        <div class="modal-content-wrap">
            <div class="modal-editor-header">
                <div class="rexeditor-modal__header__buttons-wrap">
                    <button id="content-position-open-modal" disabled class="btn-floating waves-effect waves-light tooltipped" value="image" data-position="bottom" data-tooltip="<?php _e( 'Text Position', 'rexspansive' ); ?>">
                        <i class="material-icons rex-icon">E</i>
                    </button>
                    <button id="content-padding-open-modal" disabled class="btn-floating waves-effect waves-light tooltipped" value="image" data-position="bottom" data-tooltip="<?php _e( 'Padding', 'rexspansive' ); ?>">
    ...
    <div id="rex-slider-block" class="rex-modal rexbuilder-materialize-wrap rex-modal-draggable z-depth-4">
        <div class="modal-content">
            ...
            <div class="rex-slider__import--wrap rex-modal-content__modal-area">
                ...
                <div class="rx__select-wrap"><select id="rex-slider__import" class="rx__form-input"><option value="0"><?php _e( 'New Slider', 'rexpansive-classic' ); ?></option></select><div class="rx__form-input__select-arrow"></div></div>
...
<div id="modal-internal-overlay" style="display:none;">
    <a id="get-premium" class="btn-floating waves-effect waves-light" href="http://rexpansive.neweb.info/" target="_blank">Get Premium</a>
</div>